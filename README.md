...
│   │   ├── [Framework]my-api.ts  # Framework API composable
│   │   └── api/                  # Content generated by OpenAPI generator
│   └── pages/                    # Page components
│
├── server/                       # Gin backend code
│   ├── api/                      # API definitions generated by OpenAPI
│   │   ├── Framework.export.go   # Framework exports
│   │   ├── README.md             # API documentation
│   │   ├── api_default.go        # Default API implementation
│   │   ├── model_test_response.go # Test response model
│   │   └── routers.go            # API routers
